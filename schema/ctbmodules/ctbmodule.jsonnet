...
local ctbmodule = {
    ...
    hlt: s.record("Hlt",  [
        ...
        s.field("trigger", self.hlt_trigger_seq, [
            ...
            {"id":"HLT_6", "description":"Test CRT trigger US/DS without beam consideration with no prescale", "enable":true, "minc":"0x18000", "mexc":"0x0", "prescale":"0x1"},
            ...
            {"id":"HLT_10", "description":"HV current limit threshold", "enable":true, "minc":"0x80", "mexc":"0x0", "prescale":"0x1"},
            {"id":"HLT_11", "description":"Ground plane signals", "enable":true, "minc":"0x100", "mexc":"0x0", "prescale":"0x1"},
            {"id":"HLT_12", "description":"Purity monitor signals", "enable":true, "minc":"0x200", "mexc":"0x0", "prescale":"0x1"},
    ...
    crt: s.record("Crt",  [
        ...
        s.field("triggers", self.llt_count_trigger_seq, [
            ...
            {"id":"LLT_15", "description":"Any upstream CRT", "enable":true, "mask":"0x60FC", "type":"0x1", "count":"0x0"},
            {"id":"LLT_16", "description":"Any downstream CRT", "enable":true, "mask":"0xFFFF0000", "type":"0x1", "count":"0x0"},
    ...
    beam: s.record("Beam",  [
        ...
        s.field("triggers", self.llt_mask_trigger_seq, [
            {"id":"LLT_1", "description":"Beam trigger", "enable":true, "mask":"0x1E3"},
            {"id":"LLT_2", "description":"Mask in High Pressure Cherenkov (C713)", "enable":true, "mask":"0x8"},
            {"id":"LLT_3", "description":"Mask in Low Pressure Cherenkov (C716)", "enable":true, "mask":"0x10"},
            {"id":"LLT_4", "description":"Spare", "enable":false, "mask":"0x0"},
            {"id":"LLT_5", "description":"Spare", "enable":false, "mask":"0x0"},
            {"id":"LLT_6", "description":"Beam gate selection", "enable":true, "mask":"0x2"},
            {"id":"LLT_7", "description":"HV current limit threshold (init stream)", "enable":true, "mask":"0x200"},
            {"id":"LLT_8", "description":"Ground plane signals", "enable":true, "mask":"0x400"},
            {"id":"LLT_9", "description":"Purity monitor", "enable":true, "mask":"0x1000"},
